...
int main( int argc, char** argv )
{
    ...
    //读取图像
    frame1.rgb = cv::imread( "/home/xiaoguo/Slam/part5_orb/data/new/rgb1.png" );
    frame1.depth = cv::imread( "/home/xiaoguo/Slam/part5_orb/data/new/depth1.png", -1);
    frame2.rgb = cv::imread( "/home/xiaoguo/Slam/part5_orb/data/new/rgb2.png" );
    frame2.depth = cv::imread( "/home/xiaoguo/Slam/part5_orb/data/new/depth2.png", -1 );
    ...
    //输出结果
    //[-0.02487805797728608; 0.03410364790678624; 0.01601558601701808]
    // [0.0194399712073396; 0.007305530999700888; 0.008972421593708639]
    ...
    *output += *cloud2;
    pcl::io::savePCDFile("/home/xiaoguo/Slam/part5_orb/data/result.pcd", *output);
