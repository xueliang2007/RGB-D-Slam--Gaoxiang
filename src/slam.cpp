...
int main( int argc, char** argv )
{
    ...
    *******************************/
    ...
    globalOptimizer.save("/home/xiaoguo/Slam/part5_orb/data/result_before_part7.g2o");
    //globalOptimizer.save("/home/xiaoguo/Slam/part5_orb/data/result_before_kinect_1.g2o");
    globalOptimizer.initializeOptimization();
    globalOptimizer.optimize( 100 ); //可以指定优化步数
    globalOptimizer.save( "/home/xiaoguo/Slam/part5_orb/data/result_after_part7.g2o" );
    //globalOptimizer.save( "/home/xiaoguo/Slam/part5_orb/data/result_after_kinect_1.g2o" );
    ...
    voxel.filter( *tmp );
    //存储
    pcl::io::savePCDFile( "/home/xiaoguo/Slam/part5_orb/data/result_part7.pcd", *tmp );
